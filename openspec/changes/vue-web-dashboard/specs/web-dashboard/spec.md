...
### Requirement: 宣传内容范围
首页 SHALL 不展示在线人数、校区统计、服务状态或更新时间，也不轮询在线 API。宣传 SHALL 使用正式的游戏内容介绍，不显示未完成、待规划或持续建设等进度文案，不声称不存在的玩法或室内内容。
...
#### Scenario: 正式游戏内容介绍
- **WHEN** 用户阅读首页下半页
- **THEN** 展示第一人称漫游、校园地图与校区传送、多人同游说明，场景区介绍建筑与环境，下载区直接提供客户端入口，避免重复抒情标语
