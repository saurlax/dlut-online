...
func check() -> void:
	...
	for feature: Dictionary in data.features:
		if feature.id not in ["77356","77387","77412","77413","77416","77427","77429","77431","77439","77441","77461","77499","77504","77507","77508","77510","77511","77512","77513","77514"]: continue
		assert(feature.has("osm_id") and not feature.has("reference_points"))
		if feature.id in ["77356","77387","77461","77499","77504","77507","77508","77510","77511","77512","77513","77514"]:
	...
	for sample in [["77356",-615.660,-72.108,1,0],["77356",-572.163,-35.895,0,1],["77356",-610.946,-42.791,0,1],["77356",-590.621,-46.448,1,0],["77387",356.302,379.006,1,0]]:
		var group: Node3D = model.get_node("Feature_"+str(sample[0])+"_0")
		var p := Vector3(sample[1],group.position.y+6,sample[2])
	...
	print("LINGSHUI REGISTRATION PASS: twenty roofs, registered walls and thirty-nine residence platform floors and two gabled roofs")
	quit()
