...
func check() -> void:
	...
	for f in data.features:
		if f.id not in ["1331412","2145432","81106","81107"]: continue
		...
		count += 1
	assert(count==4)
	print("SURFACE GEOMETRY PASS: two water areas and two football fields, saved boundaries/areas and surface heights")
	quit()
