...
系统 SHALL 正式发布 Windows x86_64、macOS arm64 游戏客户端及 Linux 专用游戏服务器，另允许按 android-apk-export 规范本地导出 Android arm64 测试 APK，不再导出、打包或托管浏览器游戏。既有 Web 分块与浏览器适配要求 SHALL 由本要求取代。
